	...
	<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
		<div class="w-full max-w-lg rounded-xl bg-white p-6 shadow-xl">
			...
			<div class="mt-3 rounded-lg border border-dashed border-gray-300 bg-gray-50 p-4">
				...
				<button type="button" onclick={() => downloadCsvTemplate('users',
					['ชื่อ-สกุล', 'เลขบัตรประชาชน', 'รหัสผ่าน', 'คำนำหน้า', 'ตำแหน่ง', 'ระดับตำแหน่ง', 'อีเมล', 'เบอร์โทร', 'วันเกิด', 'วันบรรจุ', 'รหัสหน่วยงาน', 'รหัสประเภทบรรจุ', 'รหัสแผนก'],
					[
						['สมชาย สุขใจ', '1234567890123', 'P@ss1234', 'นายแพทย์', 'แพทย์', 'ชำนาญการพิเศษ', 'somchai@hospital.go.th', '0812345678', '1985-03-15', '2010-06-01', '1', '1', '2'],
						['สมหญิง ดีงาม', '9876543210987', '', 'พยาบาล', 'พยาบาลวิชาชีพ', 'ชำนาญการ', '', '0891234567', '1990-08-22', '2015-04-01', '1', '1', ''],
						['วิชัย รักดี', '1111222233334', 'abc123', '', 'เจ้าพนักงานพัสดุ', 'ปฏิบัติงาน', 'wichai@hospital.go.th', '', '', '2023-01-15', '1', '3', '5'],
					]
